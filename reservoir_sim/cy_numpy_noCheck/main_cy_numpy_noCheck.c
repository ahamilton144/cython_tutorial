...
{
    "distutils": {
        "name": "main_cy_numpy_noCheck",
        "sources": [
            "main_cy_numpy_noCheck.pyx"
        ]
    },
    "module_name": "main_cy_numpy_noCheck"
}
END: Cython Metadata */
...
#define __PYX_HAVE__main_cy_numpy_noCheck
#define __PYX_HAVE_API__main_cy_numpy_noCheck
/* Early includes */
#include "pythread.h"
#include <string.h>
#include <stdlib.h>
...
struct __pyx_obj_21main_cy_numpy_noCheck_main_cy_numpy_noCheck;
...
struct __pyx_obj_21main_cy_numpy_noCheck_main_cy_numpy_noCheck {
  PyObject_HEAD
  struct __pyx_obj_5Model_Model *model;
};
...
/* Module declarations from 'main_cy_numpy_noCheck' */
static PyTypeObject *__pyx_ptype_21main_cy_numpy_noCheck_main_cy_numpy_noCheck = 0;
...
static PyObject *__pyx_f_21main_cy_numpy_noCheck___pyx_unpickle_main_cy_numpy_noCheck__set_state(struct __pyx_obj_21main_cy_numpy_noCheck_main_cy_numpy_noCheck *, PyObject *); /*proto*/
...
#define __Pyx_MODULE_NAME "main_cy_numpy_noCheck"
extern int __pyx_module_is_main_main_cy_numpy_noCheck;
int __pyx_module_is_main_main_cy_numpy_noCheck = 0;

/* Implementation of 'main_cy_numpy_noCheck' */
...
static const char __pyx_k_main_cy_numpy_noCheck[] = "main_cy_numpy_noCheck";
...
static const char __pyx_k_pyx_unpickle_main_cy_numpy_noC[] = "__pyx_unpickle_main_cy_numpy_noCheck";
...
static PyObject *__pyx_n_s_main_cy_numpy_noCheck;
...
static PyObject *__pyx_n_s_pyx_unpickle_main_cy_numpy_noC;
...
static int __pyx_pf_21main_cy_numpy_noCheck_21main_cy_numpy_noCheck___init__(struct __pyx_obj_21main_cy_numpy_noCheck_main_cy_numpy_noCheck *__pyx_v_self, int __pyx_v_years, int __pyx_v_plot, int __pyx_v_seed); /* proto */
static PyObject *__pyx_pf_21main_cy_numpy_noCheck_21main_cy_numpy_noCheck_5model___get__(struct __pyx_obj_21main_cy_numpy_noCheck_main_cy_numpy_noCheck *__pyx_v_self); /* proto */
static int __pyx_pf_21main_cy_numpy_noCheck_21main_cy_numpy_noCheck_5model_2__set__(struct __pyx_obj_21main_cy_numpy_noCheck_main_cy_numpy_noCheck *__pyx_v_self, PyObject *__pyx_v_value); /* proto */
static int __pyx_pf_21main_cy_numpy_noCheck_21main_cy_numpy_noCheck_5model_4__del__(struct __pyx_obj_21main_cy_numpy_noCheck_main_cy_numpy_noCheck *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_21main_cy_numpy_noCheck_21main_cy_numpy_noCheck_2__reduce_cython__(struct __pyx_obj_21main_cy_numpy_noCheck_main_cy_numpy_noCheck *__pyx_v_self); /* proto */
static PyObject *__pyx_pf_21main_cy_numpy_noCheck_21main_cy_numpy_noCheck_4__setstate_cython__(struct __pyx_obj_21main_cy_numpy_noCheck_main_cy_numpy_noCheck *__pyx_v_self, PyObject *__pyx_v___pyx_state); /* proto */
static PyObject *__pyx_pf_21main_cy_numpy_noCheck___pyx_unpickle_main_cy_numpy_noCheck(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v___pyx_type, long __pyx_v___pyx_checksum, PyObject *__pyx_v___pyx_state); /* proto */
...
static PyObject *__pyx_tp_new_21main_cy_numpy_noCheck_main_cy_numpy_noCheck(PyTypeObject *t, PyObject *a, PyObject *k); /*proto*/
...
/* Python wrapper */
static int __pyx_pw_21main_cy_numpy_noCheck_21main_cy_numpy_noCheck_1__init__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static int __pyx_pw_21main_cy_numpy_noCheck_21main_cy_numpy_noCheck_1__init__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  int __pyx_v_years;
  int __pyx_v_plot;
  int __pyx_v_seed;
  int __pyx_lineno = 0;
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("main_cy_numpy_noCheck.main_cy_numpy_noCheck.__init__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return -1;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_21main_cy_numpy_noCheck_21main_cy_numpy_noCheck___init__(((struct __pyx_obj_21main_cy_numpy_noCheck_main_cy_numpy_noCheck *)__pyx_v_self), __pyx_v_years, __pyx_v_plot, __pyx_v_seed);
...
static int __pyx_pf_21main_cy_numpy_noCheck_21main_cy_numpy_noCheck___init__(struct __pyx_obj_21main_cy_numpy_noCheck_main_cy_numpy_noCheck *__pyx_v_self, int __pyx_v_years, int __pyx_v_plot, int __pyx_v_seed) {
  int __pyx_r;
 ...
 */
  ...
  __pyx_t_2 = __Pyx_PyInt_From_int(__pyx_v_years); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 12, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_t_1, __pyx_n_s_years, __pyx_t_2) < 0) __PYX_ERR(0, 12, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_PyBool_FromLong(__pyx_v_plot); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 12, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_t_1, __pyx_n_s_plot, __pyx_t_2) < 0) __PYX_ERR(0, 12, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_PyInt_From_int(__pyx_v_seed); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 12, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_t_1, __pyx_n_s_seed, __pyx_t_2) < 0) __PYX_ERR(0, 12, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_PyObject_Call(((PyObject *)__pyx_ptype_5Model_Model), __pyx_empty_tuple, __pyx_t_1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 12, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_GIVEREF(__pyx_t_2);
  __Pyx_GOTREF(__pyx_v_self->model);
  __Pyx_DECREF(((PyObject *)__pyx_v_self->model));
  __pyx_v_self->model = ((struct __pyx_obj_5Model_Model *)__pyx_t_2);
  __pyx_t_2 = 0;

  /* "main_cy_numpy_noCheck.pyx":15
 * 
 *     # run simulation
 ...
 *     # plot results
 */
  __pyx_v_self->model->tot_storage = ((struct __pyx_vtabstruct_5Model_Model *)__pyx_v_self->model->__pyx_vtab)->run(__pyx_v_self->model);

  /* "main_cy_numpy_noCheck.pyx":18
 * 
 *     # plot results
 *     if self.model.plot:             # <<<<<<<<<<<<<<
 ...
 * 
 */
  __pyx_t_3 = (__pyx_v_self->model->plot != 0);
  if (__pyx_t_3) {

    /* "main_cy_numpy_noCheck.pyx":19
 *     # plot results
 *     if self.model.plot:
 *       self.model.plot_results()             # <<<<<<<<<<<<<<
 * 
 */
    __pyx_t_1 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_self->model), __pyx_n_s_plot_results); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 19, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_4 = NULL;
...
/* Python wrapper */
static PyObject *__pyx_pw_21main_cy_numpy_noCheck_21main_cy_numpy_noCheck_5model_1__get__(PyObject *__pyx_v_self); /*proto*/
static PyObject *__pyx_pw_21main_cy_numpy_noCheck_21main_cy_numpy_noCheck_5model_1__get__(PyObject *__pyx_v_self) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__get__ (wrapper)", 0);
  __pyx_r = __pyx_pf_21main_cy_numpy_noCheck_21main_cy_numpy_noCheck_5model___get__(((struct __pyx_obj_21main_cy_numpy_noCheck_main_cy_numpy_noCheck *)__pyx_v_self));
...
static PyObject *__pyx_pf_21main_cy_numpy_noCheck_21main_cy_numpy_noCheck_5model___get__(struct __pyx_obj_21main_cy_numpy_noCheck_main_cy_numpy_noCheck *__pyx_v_self) {
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_AddTraceback("main_cy_numpy_noCheck.main_cy_numpy_noCheck.model.__get__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __pyx_L0:;
...
/* Python wrapper */
static int __pyx_pw_21main_cy_numpy_noCheck_21main_cy_numpy_noCheck_5model_3__set__(PyObject *__pyx_v_self, PyObject *__pyx_v_value); /*proto*/
static int __pyx_pw_21main_cy_numpy_noCheck_21main_cy_numpy_noCheck_5model_3__set__(PyObject *__pyx_v_self, PyObject *__pyx_v_value) {
  int __pyx_r;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__set__ (wrapper)", 0);
  __pyx_r = __pyx_pf_21main_cy_numpy_noCheck_21main_cy_numpy_noCheck_5model_2__set__(((struct __pyx_obj_21main_cy_numpy_noCheck_main_cy_numpy_noCheck *)__pyx_v_self), ((PyObject *)__pyx_v_value));
...
static int __pyx_pf_21main_cy_numpy_noCheck_21main_cy_numpy_noCheck_5model_2__set__(struct __pyx_obj_21main_cy_numpy_noCheck_main_cy_numpy_noCheck *__pyx_v_self, PyObject *__pyx_v_value) {
  int __pyx_r;
  __Pyx_TraceDeclarations
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  ...
  if (!(likely(((__pyx_v_value) == Py_None) || likely(__Pyx_TypeTest(__pyx_v_value, __pyx_ptype_5Model_Model))))) __PYX_ERR(0, 8, __pyx_L1_error)
  __pyx_t_1 = __pyx_v_value;
  __Pyx_INCREF(__pyx_t_1);
  __Pyx_GIVEREF(__pyx_t_1);
  __Pyx_GOTREF(__pyx_v_self->model);
  __Pyx_DECREF(((PyObject *)__pyx_v_self->model));
  __pyx_v_self->model = ((struct __pyx_obj_5Model_Model *)__pyx_t_1);
  __pyx_t_1 = 0;
  ...
  __pyx_L1_error:;
  __Pyx_XDECREF(__pyx_t_1);
  __Pyx_AddTraceback("main_cy_numpy_noCheck.main_cy_numpy_noCheck.model.__set__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = -1;
  __pyx_L0:;
  __Pyx_TraceReturn(Py_None, 0);
  __Pyx_RefNannyFinishContext();
...
/* Python wrapper */
static int __pyx_pw_21main_cy_numpy_noCheck_21main_cy_numpy_noCheck_5model_5__del__(PyObject *__pyx_v_self); /*proto*/
static int __pyx_pw_21main_cy_numpy_noCheck_21main_cy_numpy_noCheck_5model_5__del__(PyObject *__pyx_v_self) {
  int __pyx_r;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__del__ (wrapper)", 0);
  __pyx_r = __pyx_pf_21main_cy_numpy_noCheck_21main_cy_numpy_noCheck_5model_4__del__(((struct __pyx_obj_21main_cy_numpy_noCheck_main_cy_numpy_noCheck *)__pyx_v_self));
...
static int __pyx_pf_21main_cy_numpy_noCheck_21main_cy_numpy_noCheck_5model_4__del__(struct __pyx_obj_21main_cy_numpy_noCheck_main_cy_numpy_noCheck *__pyx_v_self) {
  int __pyx_r;
  __Pyx_TraceDeclarations
  __Pyx_RefNannyDeclarations
  int __pyx_lineno = 0;
  ...
  __Pyx_GOTREF(__pyx_v_self->model);
  __Pyx_DECREF(((PyObject *)__pyx_v_self->model));
  __pyx_v_self->model = ((struct __pyx_obj_5Model_Model *)Py_None);

  /* function exit code */
  __pyx_r = 0;
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_AddTraceback("main_cy_numpy_noCheck.main_cy_numpy_noCheck.model.__del__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = -1;
  __pyx_L0:;
  __Pyx_TraceReturn(Py_None, 0);
  __Pyx_RefNannyFinishContext();
...
/* Python wrapper */
static PyObject *__pyx_pw_21main_cy_numpy_noCheck_21main_cy_numpy_noCheck_3__reduce_cython__(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_pw_21main_cy_numpy_noCheck_21main_cy_numpy_noCheck_3__reduce_cython__(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__reduce_cython__ (wrapper)", 0);
  __pyx_r = __pyx_pf_21main_cy_numpy_noCheck_21main_cy_numpy_noCheck_2__reduce_cython__(((struct __pyx_obj_21main_cy_numpy_noCheck_main_cy_numpy_noCheck *)__pyx_v_self));
...
static PyObject *__pyx_pf_21main_cy_numpy_noCheck_21main_cy_numpy_noCheck_2__reduce_cython__(struct __pyx_obj_21main_cy_numpy_noCheck_main_cy_numpy_noCheck *__pyx_v_self) {
 ...
 *         use_setstate = self.model is not None             # <<<<<<<<<<<<<<
 *     if use_setstate:
 *         return __pyx_unpickle_main_cy_numpy_noCheck, (type(self), 0x20f35e6, None), state
 */
  /*else*/ {
    __pyx_t_3 = (((PyObject *)__pyx_v_self->model) != Py_None);
 ...
 *         return __pyx_unpickle_main_cy_numpy_noCheck, (type(self), 0x20f35e6, None), state             # <<<<<<<<<<<<<<
 *     else:
 *         return __pyx_unpickle_main_cy_numpy_noCheck, (type(self), 0x20f35e6, state)
 */
    __Pyx_XDECREF(__pyx_r);
    __Pyx_GetModuleGlobalName(__pyx_t_4, __pyx_n_s_pyx_unpickle_main_cy_numpy_noC); if (unlikely(!__pyx_t_4)) __PYX_ERR(1, 13, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
 ...
 *     __pyx_unpickle_main_cy_numpy_noCheck__set_state(self, __pyx_state)
 */
  /*else*/ {
    __Pyx_XDECREF(__pyx_r);
    __Pyx_GetModuleGlobalName(__pyx_t_5, __pyx_n_s_pyx_unpickle_main_cy_numpy_noC); if (unlikely(!__pyx_t_5)) __PYX_ERR(1, 15, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
 ...
 */
  ...
  __Pyx_AddTraceback("main_cy_numpy_noCheck.main_cy_numpy_noCheck.__reduce_cython__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_21main_cy_numpy_noCheck_21main_cy_numpy_noCheck_5__setstate_cython__(PyObject *__pyx_v_self, PyObject *__pyx_v___pyx_state); /*proto*/
static PyObject *__pyx_pw_21main_cy_numpy_noCheck_21main_cy_numpy_noCheck_5__setstate_cython__(PyObject *__pyx_v_self, PyObject *__pyx_v___pyx_state) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__setstate_cython__ (wrapper)", 0);
  __pyx_r = __pyx_pf_21main_cy_numpy_noCheck_21main_cy_numpy_noCheck_4__setstate_cython__(((struct __pyx_obj_21main_cy_numpy_noCheck_main_cy_numpy_noCheck *)__pyx_v_self), ((PyObject *)__pyx_v___pyx_state));
...
static PyObject *__pyx_pf_21main_cy_numpy_noCheck_21main_cy_numpy_noCheck_4__setstate_cython__(struct __pyx_obj_21main_cy_numpy_noCheck_main_cy_numpy_noCheck *__pyx_v_self, PyObject *__pyx_v___pyx_state) {
  PyObject *__pyx_r = NULL;
  __Pyx_TraceDeclarations
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
 ...
 */
  ...
  __pyx_t_1 = __pyx_f_21main_cy_numpy_noCheck___pyx_unpickle_main_cy_numpy_noCheck__set_state(__pyx_v_self, ((PyObject*)__pyx_v___pyx_state)); if (unlikely(!__pyx_t_1)) __PYX_ERR(1, 17, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  __pyx_L1_error:;
  __Pyx_XDECREF(__pyx_t_1);
  __Pyx_AddTraceback("main_cy_numpy_noCheck.main_cy_numpy_noCheck.__setstate_cython__", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_TraceReturn(__pyx_r, 0);
...
/* "(tree fragment)":1
 * def __pyx_unpickle_main_cy_numpy_noCheck(__pyx_type, long __pyx_checksum, __pyx_state):             # <<<<<<<<<<<<<<
 *     cdef object __pyx_PickleError
 *     cdef object __pyx_result
 */

/* Python wrapper */
static PyObject *__pyx_pw_21main_cy_numpy_noCheck_1__pyx_unpickle_main_cy_numpy_noCheck(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_21main_cy_numpy_noCheck_1__pyx_unpickle_main_cy_numpy_noCheck = {"__pyx_unpickle_main_cy_numpy_noCheck", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_21main_cy_numpy_noCheck_1__pyx_unpickle_main_cy_numpy_noCheck, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_21main_cy_numpy_noCheck_1__pyx_unpickle_main_cy_numpy_noCheck(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("__pyx_unpickle_main_cy_numpy_noCheck (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_pyx_checksum)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("__pyx_unpickle_main_cy_numpy_noCheck", 1, 3, 3, 1); __PYX_ERR(1, 1, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_pyx_state)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("__pyx_unpickle_main_cy_numpy_noCheck", 1, 3, 3, 2); __PYX_ERR(1, 1, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "__pyx_unpickle_main_cy_numpy_noCheck") < 0)) __PYX_ERR(1, 1, __pyx_L3_error)
      }
    } else if (PyTuple_GET_SIZE(__pyx_args) != 3) {
      goto __pyx_L5_argtuple_error;
    } else {
  ...
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("__pyx_unpickle_main_cy_numpy_noCheck", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(1, 1, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("main_cy_numpy_noCheck.__pyx_unpickle_main_cy_numpy_noCheck", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_21main_cy_numpy_noCheck___pyx_unpickle_main_cy_numpy_noCheck(__pyx_self, __pyx_v___pyx_type, __pyx_v___pyx_checksum, __pyx_v___pyx_state);
...
static PyObject *__pyx_pf_21main_cy_numpy_noCheck___pyx_unpickle_main_cy_numpy_noCheck(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v___pyx_type, long __pyx_v___pyx_checksum, PyObject *__pyx_v___pyx_state) {
  ...
  __Pyx_RefNannySetupContext("__pyx_unpickle_main_cy_numpy_noCheck", 0);
  __Pyx_TraceCall("__pyx_unpickle_main_cy_numpy_noCheck", __pyx_f[1], 1, 0, __PYX_ERR(1, 1, __pyx_L1_error));
 ...
 *         from pickle import PickleError as __pyx_PickleError             # <<<<<<<<<<<<<<
 *         raise __pyx_PickleError("Incompatible checksums (%s vs 0x20f35e6 = (model))" % __pyx_checksum)
 *     __pyx_result = main_cy_numpy_noCheck.__new__(__pyx_type)
 */
 ...
 *     __pyx_result = main_cy_numpy_noCheck.__new__(__pyx_type)             # <<<<<<<<<<<<<<
 *     if __pyx_state is not None:
 *         __pyx_unpickle_main_cy_numpy_noCheck__set_state(<main_cy_numpy_noCheck> __pyx_result, __pyx_state)
 */
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_ptype_21main_cy_numpy_noCheck_main_cy_numpy_noCheck), __pyx_n_s_new); if (unlikely(!__pyx_t_2)) __PYX_ERR(1, 7, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_4 = NULL;
 ...
 *         __pyx_unpickle_main_cy_numpy_noCheck__set_state(<main_cy_numpy_noCheck> __pyx_result, __pyx_state)             # <<<<<<<<<<<<<<
 *     return __pyx_result
 * cdef __pyx_unpickle_main_cy_numpy_noCheck__set_state(main_cy_numpy_noCheck __pyx_result, tuple __pyx_state):
 */
    if (!(likely(PyTuple_CheckExact(__pyx_v___pyx_state))||((__pyx_v___pyx_state) == Py_None)||(PyErr_Format(PyExc_TypeError, "Expected %.16s, got %.200s", "tuple", Py_TYPE(__pyx_v___pyx_state)->tp_name), 0))) __PYX_ERR(1, 9, __pyx_L1_error)
    __pyx_t_3 = __pyx_f_21main_cy_numpy_noCheck___pyx_unpickle_main_cy_numpy_noCheck__set_state(((struct __pyx_obj_21main_cy_numpy_noCheck_main_cy_numpy_noCheck *)__pyx_v___pyx_result), ((PyObject*)__pyx_v___pyx_state)); if (unlikely(!__pyx_t_3)) __PYX_ERR(1, 9, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
...
static PyObject *__pyx_f_21main_cy_numpy_noCheck___pyx_unpickle_main_cy_numpy_noCheck__set_state(struct __pyx_obj_21main_cy_numpy_noCheck_main_cy_numpy_noCheck *__pyx_v___pyx_result, PyObject *__pyx_v___pyx_state) {
  PyObject *__pyx_r = NULL;
  __Pyx_TraceDeclarations
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("__pyx_unpickle_main_cy_numpy_noCheck__set_state", 0);
  __Pyx_TraceCall("__pyx_unpickle_main_cy_numpy_noCheck__set_state", __pyx_f[1], 11, 0, __PYX_ERR(1, 11, __pyx_L1_error));
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  if (!(likely(((__pyx_t_1) == Py_None) || likely(__Pyx_TypeTest(__pyx_t_1, __pyx_ptype_5Model_Model))))) __PYX_ERR(1, 12, __pyx_L1_error)
  __Pyx_GIVEREF(__pyx_t_1);
  __Pyx_GOTREF(__pyx_v___pyx_result->model);
  __Pyx_DECREF(((PyObject *)__pyx_v___pyx_result->model));
  __pyx_v___pyx_result->model = ((struct __pyx_obj_5Model_Model *)__pyx_t_1);
  __pyx_t_1 = 0;
 ...
 */
  ...
  __Pyx_AddTraceback("main_cy_numpy_noCheck.__pyx_unpickle_main_cy_numpy_noCheck__set_state", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_TraceReturn(__pyx_r, 0);
...
static PyObject *__pyx_tp_new_21main_cy_numpy_noCheck_main_cy_numpy_noCheck(PyTypeObject *t, CYTHON_UNUSED PyObject *a, CYTHON_UNUSED PyObject *k) {
  struct __pyx_obj_21main_cy_numpy_noCheck_main_cy_numpy_noCheck *p;
  PyObject *o;
  ...
  p = ((struct __pyx_obj_21main_cy_numpy_noCheck_main_cy_numpy_noCheck *)o);
  p->model = ((struct __pyx_obj_5Model_Model *)Py_None); Py_INCREF(Py_None);
  return o;
}

static void __pyx_tp_dealloc_21main_cy_numpy_noCheck_main_cy_numpy_noCheck(PyObject *o) {
  struct __pyx_obj_21main_cy_numpy_noCheck_main_cy_numpy_noCheck *p = (struct __pyx_obj_21main_cy_numpy_noCheck_main_cy_numpy_noCheck *)o;
...
static int __pyx_tp_traverse_21main_cy_numpy_noCheck_main_cy_numpy_noCheck(PyObject *o, visitproc v, void *a) {
  int e;
  struct __pyx_obj_21main_cy_numpy_noCheck_main_cy_numpy_noCheck *p = (struct __pyx_obj_21main_cy_numpy_noCheck_main_cy_numpy_noCheck *)o;
  if (p->model) {
...
static int __pyx_tp_clear_21main_cy_numpy_noCheck_main_cy_numpy_noCheck(PyObject *o) {
  PyObject* tmp;
  struct __pyx_obj_21main_cy_numpy_noCheck_main_cy_numpy_noCheck *p = (struct __pyx_obj_21main_cy_numpy_noCheck_main_cy_numpy_noCheck *)o;
...
static PyObject *__pyx_getprop_21main_cy_numpy_noCheck_21main_cy_numpy_noCheck_model(PyObject *o, CYTHON_UNUSED void *x) {
  return __pyx_pw_21main_cy_numpy_noCheck_21main_cy_numpy_noCheck_5model_1__get__(o);
}

static int __pyx_setprop_21main_cy_numpy_noCheck_21main_cy_numpy_noCheck_model(PyObject *o, PyObject *v, CYTHON_UNUSED void *x) {
  if (v) {
    return __pyx_pw_21main_cy_numpy_noCheck_21main_cy_numpy_noCheck_5model_3__set__(o, v);
  }
  else {
    return __pyx_pw_21main_cy_numpy_noCheck_21main_cy_numpy_noCheck_5model_5__del__(o);
  }
}

static PyMethodDef __pyx_methods_21main_cy_numpy_noCheck_main_cy_numpy_noCheck[] = {
  {"__reduce_cython__", (PyCFunction)__pyx_pw_21main_cy_numpy_noCheck_21main_cy_numpy_noCheck_3__reduce_cython__, METH_NOARGS, 0},
  {"__setstate_cython__", (PyCFunction)__pyx_pw_21main_cy_numpy_noCheck_21main_cy_numpy_noCheck_5__setstate_cython__, METH_O, 0},
  {0, 0, 0, 0}
};

static struct PyGetSetDef __pyx_getsets_21main_cy_numpy_noCheck_main_cy_numpy_noCheck[] = {
  {(char *)"model", __pyx_getprop_21main_cy_numpy_noCheck_21main_cy_numpy_noCheck_model, __pyx_setprop_21main_cy_numpy_noCheck_21main_cy_numpy_noCheck_model, (char *)0, 0},
  {0, 0, 0, 0, 0}
};

static PyTypeObject __pyx_type_21main_cy_numpy_noCheck_main_cy_numpy_noCheck = {
  PyVarObject_HEAD_INIT(0, 0)
  "main_cy_numpy_noCheck.main_cy_numpy_noCheck", /*tp_name*/
  sizeof(struct __pyx_obj_21main_cy_numpy_noCheck_main_cy_numpy_noCheck), /*tp_basicsize*/
  0, /*tp_itemsize*/
  __pyx_tp_dealloc_21main_cy_numpy_noCheck_main_cy_numpy_noCheck, /*tp_dealloc*/
  ...
  0, /*tp_doc*/
  __pyx_tp_traverse_21main_cy_numpy_noCheck_main_cy_numpy_noCheck, /*tp_traverse*/
  __pyx_tp_clear_21main_cy_numpy_noCheck_main_cy_numpy_noCheck, /*tp_clear*/
  0, /*tp_richcompare*/
  0, /*tp_weaklistoffset*/
  0, /*tp_iter*/
  0, /*tp_iternext*/
  __pyx_methods_21main_cy_numpy_noCheck_main_cy_numpy_noCheck, /*tp_methods*/
  0, /*tp_members*/
  __pyx_getsets_21main_cy_numpy_noCheck_main_cy_numpy_noCheck, /*tp_getset*/
  0, /*tp_base*/
  0, /*tp_dict*/
  0, /*tp_descr_get*/
  0, /*tp_descr_set*/
  0, /*tp_dictoffset*/
  __pyx_pw_21main_cy_numpy_noCheck_21main_cy_numpy_noCheck_1__init__, /*tp_init*/
  0, /*tp_alloc*/
  __pyx_tp_new_21main_cy_numpy_noCheck_main_cy_numpy_noCheck, /*tp_new*/
  0, /*tp_free*/
  0, /*tp_is_gc*/
  0, /*tp_bases*/
  0, /*tp_mro*/
...
static PyTypeObject __pyx_type___pyx_array = {
  PyVarObject_HEAD_INIT(0, 0)
  "main_cy_numpy_noCheck.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "main_cy_numpy_noCheck.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "main_cy_numpy_noCheck.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "main_cy_numpy_noCheck._memoryviewslice", /*tp_name*/
...
static int __pyx_pymod_exec_main_cy_numpy_noCheck(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_main_cy_numpy_noCheck},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_main_cy_numpy_noCheck, __pyx_k_main_cy_numpy_noCheck, sizeof(__pyx_k_main_cy_numpy_noCheck), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_pyx_unpickle_main_cy_numpy_noC, __pyx_k_pyx_unpickle_main_cy_numpy_noC, sizeof(__pyx_k_pyx_unpickle_main_cy_numpy_noC), 0, 0, 1, 1},
 ...
 */
  ...
  __pyx_codeobj_ = (PyObject*)__Pyx_PyCode_New(3, 0, 5, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__21, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_stringsource, __pyx_n_s_pyx_unpickle_main_cy_numpy_noC, 1, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj_)) __PYX_ERR(1, 1, __pyx_L1_error)
...
static int __Pyx_modinit_type_init_code(void) {
  ...
  /*--- Type init code ---*/
  if (PyType_Ready(&__pyx_type_21main_cy_numpy_noCheck_main_cy_numpy_noCheck) < 0) __PYX_ERR(0, 7, __pyx_L1_error)
  #if PY_VERSION_HEX < 0x030800B1
  __pyx_type_21main_cy_numpy_noCheck_main_cy_numpy_noCheck.tp_print = 0;
  #endif
  if ((CYTHON_USE_TYPE_SLOTS && CYTHON_USE_PYTYPE_LOOKUP) && likely(!__pyx_type_21main_cy_numpy_noCheck_main_cy_numpy_noCheck.tp_dictoffset && __pyx_type_21main_cy_numpy_noCheck_main_cy_numpy_noCheck.tp_getattro == PyObject_GenericGetAttr)) {
    __pyx_type_21main_cy_numpy_noCheck_main_cy_numpy_noCheck.tp_getattro = __Pyx_PyObject_GenericGetAttr;
  }
  if (PyObject_SetAttr(__pyx_m, __pyx_n_s_main_cy_numpy_noCheck, (PyObject *)&__pyx_type_21main_cy_numpy_noCheck_main_cy_numpy_noCheck) < 0) __PYX_ERR(0, 7, __pyx_L1_error)
  if (__Pyx_setup_reduce((PyObject*)&__pyx_type_21main_cy_numpy_noCheck_main_cy_numpy_noCheck) < 0) __PYX_ERR(0, 7, __pyx_L1_error)
  __pyx_ptype_21main_cy_numpy_noCheck_main_cy_numpy_noCheck = &__pyx_type_21main_cy_numpy_noCheck_main_cy_numpy_noCheck;
...
static int __Pyx_modinit_type_import_code(void) {
  ...
  /*--- Type import code ---*/
  __pyx_t_1 = PyImport_ImportModule("Demand"); if (unlikely(!__pyx_t_1)) __PYX_ERR(2, 3, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_ptype_6Demand_Demand = __Pyx_ImportType(__pyx_t_1, "Demand", "Demand", sizeof(struct __pyx_obj_6Demand_Demand), __Pyx_ImportType_CheckSize_Warn);
   if (!__pyx_ptype_6Demand_Demand) __PYX_ERR(2, 3, __pyx_L1_error)
  __pyx_vtabptr_6Demand_Demand = (struct __pyx_vtabstruct_6Demand_Demand*)__Pyx_GetVtable(__pyx_ptype_6Demand_Demand->tp_dict); if (unlikely(!__pyx_vtabptr_6Demand_Demand)) __PYX_ERR(2, 3, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyImport_ImportModule("Reservoir"); if (unlikely(!__pyx_t_1)) __PYX_ERR(3, 5, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_ptype_9Reservoir_Reservoir = __Pyx_ImportType(__pyx_t_1, "Reservoir", "Reservoir", sizeof(struct __pyx_obj_9Reservoir_Reservoir), __Pyx_ImportType_CheckSize_Warn);
   if (!__pyx_ptype_9Reservoir_Reservoir) __PYX_ERR(3, 5, __pyx_L1_error)
  __pyx_vtabptr_9Reservoir_Reservoir = (struct __pyx_vtabstruct_9Reservoir_Reservoir*)__Pyx_GetVtable(__pyx_ptype_9Reservoir_Reservoir->tp_dict); if (unlikely(!__pyx_vtabptr_9Reservoir_Reservoir)) __PYX_ERR(3, 5, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyImport_ImportModule("Model"); if (unlikely(!__pyx_t_1)) __PYX_ERR(4, 5, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_ptype_5Model_Model = __Pyx_ImportType(__pyx_t_1, "Model", "Model", sizeof(struct __pyx_obj_5Model_Model), __Pyx_ImportType_CheckSize_Warn);
   if (!__pyx_ptype_5Model_Model) __PYX_ERR(4, 5, __pyx_L1_error)
  __pyx_vtabptr_5Model_Model = (struct __pyx_vtabstruct_5Model_Model*)__Pyx_GetVtable(__pyx_ptype_5Model_Model->tp_dict); if (unlikely(!__pyx_vtabptr_5Model_Model)) __PYX_ERR(4, 5, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initmain_cy_numpy_noCheck(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initmain_cy_numpy_noCheck(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_main_cy_numpy_noCheck(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_main_cy_numpy_noCheck(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_main_cy_numpy_noCheck(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  __Pyx_TraceDeclarations
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'main_cy_numpy_noCheck' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_main_cy_numpy_noCheck(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("main_cy_numpy_noCheck", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_main_cy_numpy_noCheck) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "main_cy_numpy_noCheck")) {
      if (unlikely(PyDict_SetItemString(modules, "main_cy_numpy_noCheck", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  #endif
  __Pyx_TraceCall("__Pyx_PyMODINIT_FUNC PyInit_main_cy_numpy_noCheck(void)", __pyx_f[0], 1, 0, __PYX_ERR(0, 1, __pyx_L1_error));
 ...
 *     cdef object __pyx_result
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_21main_cy_numpy_noCheck_1__pyx_unpickle_main_cy_numpy_noCheck, NULL, __pyx_n_s_main_cy_numpy_noCheck); if (unlikely(!__pyx_t_1)) __PYX_ERR(1, 1, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_pyx_unpickle_main_cy_numpy_noC, __pyx_t_1) < 0) __PYX_ERR(1, 1, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "main_cy_numpy_noCheck.pyx":1
 * # cython: profile=True             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init main_cy_numpy_noCheck", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init main_cy_numpy_noCheck");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
